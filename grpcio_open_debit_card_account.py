...
# Создаём gRPC-клиент для AccountsGatewayServiceStub
...
print('Account debit request:', account_debit_request)

# Отправляем запрос и получаем ответ
open_debit_card_response: OpenDebitCardAccountResponse = account_gateway_service.OpenDebitCardAccount(account_debit_request)
