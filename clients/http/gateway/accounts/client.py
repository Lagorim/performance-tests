...
class OpenDebitAccountResponseDict(TypedDict):
    """
...
class OpenCreditAccountResponseDict(TypedDict):
    """
...
class AccountGatewayHTTPClient(HTTPClient):
    ...
    def get_account(self, user_id: str) -> GetAccountResponseDict:
        ...
        response = self.get_account_api(query)
    ...
    #Добавили новый метод
    def open_debit_card_account(self, user_id: str) -> OpenDebitAccountResponseDict:
        request = OpenDebitCardAccountRequestDict(userId=user_id)
        response = self.open_debit_card_account_api(request)
        return response.json()
    
    #Добавили новый метод
    def open_credit_card_account(self, user_id: str) -> OpenCreditAccountResponseDict:
