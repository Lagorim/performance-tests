...
class CardsGatewayGRPCClient(GRPCClient):
    ...
    def __init__(self, channel: Channel):
        ...
        :param channel: gRPC-канал для подключения к CardGatewayService.
        """
        super().__init__(channel)
        
        self.stub = CardsGatewayServiceStub(channel)  # gRPC-стаб, сгенерированный из .proto

    def issue_virtual_card_api(self, request:IssueVirtualCardRequest) -> IssuePhysicalCardResponse:
        """
        Метод для создания виртуальной карты через CardGatewayService.

        :param request: Запрос для создания виртуальной карты.
        :return: Ответ от CardGatewayService с информацией о созданной карте.
        """
    ...
    def issue_physical_card_api(self, request:IssuePhysicalCardRequest) -> IssuePhysicalCardResponse:
        """
        Метод для создания физической карты через CardGatewayService.

        :param request: Запрос для создания физической карты.
        :return: Ответ от CardGatewayService с информацией о созданной карте.
        """
